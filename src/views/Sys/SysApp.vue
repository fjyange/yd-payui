  ...
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			<el-form-item>
				<el-input v-model="filters.V_APP_NAME" placeholder="平台名称"></el-input>
			</el-form-item>
			<el-form-item>
				<el-input v-model="filters.V_USER_ACCOUNT" placeholder="平台登录名"></el-input>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-search" :label="$t('action.search')" perms="sys:app:search" type="primary" @click="findPage(true)"/>
			</el-form-item>
			<el-form-item>
				<kt-button icon="fa fa-plus" :label="$t('action.add')" perms="sys:app:add" type="primary" @click="handleAdd" />
			</el-form-item>
		</el-form>
	</div>
	<!--表格内容栏-->
    <el-table :data="pageResult.content" style="width: 100%"  v-loading="loading" :element-loading-text="$t('action.loading')">
      ...
      ></el-table-column>
      <el-table-column prop="V_IS_MATCH" label="是否允许接入" width="120">
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="100px" :rules="dataFormRules" ref="dataForm" :size="size"
			...
			<el-form-item label="允许接入" prop="V_IS_MATCH">
				<el-select v-model="dataForm.V_IS_MATCH" placeholder="请选择" style="width: 100%;">
					<el-option label="是" value="Y"></el-option>
					<el-option label="否" value="N"></el-option>
				</el-select>
			</el-form-item>
			<el-form-item label="角色" prop="V_ROLE_ID">
				<el-select v-model="dataForm.V_ROLE_ID" placeholder="请选择"
					 style="width: 100%;">
					<el-option v-for="item in roles" :key="item.ROLE_ID"
